...
$(document).on('mouseenter mouseleave', 'section.page-blocks area', function (event) {
    if ($(window).width() > 760) {
        ...
        if (event.type == "mouseenter") $('.' + target.attr('data-block'), wrapper).addClass('in');

        if (event.type == "mouseleave") $('.' + target.attr('data-block'), wrapper).removeClass('in');
    }
});

//

var plan_a_keys = [{ unit: 1, url: '/Themes/hayat2/img/plan/A/keys/Block A Plan 001.png' }, { unit: 2, url: '/Themes/hayat2/img/plan/A/keys/Block A Plan 002.png' }, { unit: 3, url: '/Themes/hayat2/img/plan/A/keys/Block A Plan 003.png' }, { unit: 4, url: '/Themes/hayat2/img/plan/A/keys/Block A Plan 004.png' }];

var plan_b_keys = [{ unit: 1, url: '/Themes/hayat2/img/plan/B/keys/Block B Plan-01.png' }, { unit: 2, url: '/Themes/hayat2/img/plan/B/keys/Block B Plan-02.png' }, { unit: 3, url: '/Themes/hayat2/img/plan/B/keys/Block B Plan-03.png' }, { unit: 4, url: '/Themes/hayat2/img/plan/B/keys/Block B Plan-04.png' }, { unit: 5, url: '/Themes/hayat2/img/plan/B/keys/Block B Plan-05.png' }];

var plan_c_keys = [{ unit: 1, url: '/Themes/hayat2/img/plan/C/keys/Block C Plan 01.png' }, { unit: 2, url: '/Themes/hayat2/img/plan/C/keys/Block C Plan 02.png' }, { unit: 3, url: '/Themes/hayat2/img/plan/C/keys/Block C Plan 03.png' }, { unit: 4, url: '/Themes/hayat2/img/plan/C/keys/Block C Plan 04.png' }, { unit: 5, url: '/Themes/hayat2/img/plan/C/keys/Block C Plan 05.png' }];

$(document).on('tap click', '#recortes-plan-a area', function () {

    var unit = $(this).attr('data-unit');
    var find = plan_a_keys.find(function (a) {
        return a.unit == unit;
    });
...
$('#recortes-plan-b area').click(function () {
    var unit = $(this).attr('data-unit');
    var find = plan_b_keys.find(function (a) {
        return a.unit == unit;
    });
...
$('#recortes-plan-c area').click(function () {
    var unit = $(this).attr('data-unit');
    var find = plan_c_keys.find(function (a) {
        return a.unit == unit;
    });
...
$(document).on('tap click', '.mobile-block .unit li', function () {
    ...
    switch (parent.attr('id')) {
        case 'block-a':
            find = plan_a_keys.find(function (a) {
                return a.unit == unit;
            });
            break;
        case 'block-b':
            find = plan_b_keys.find(function (a) {
                return a.unit == unit;
            });
            break;
        case 'block-c':
            find = plan_c_keys.find(function (a) {
                return a.unit == unit;
            });
            break;
        default:
...
$(document).on('mouseenter mouseleave', '#recortes-main area', function (e) {
    ...
    } else $(this).parents('#blocks').find('.table tr[data-block-id=' + blockId + ']').removeClass(className);
});
